...
export const categories: GuideCategory[] = [
  ...
  },
  {
    id: "cursos",
    title: "Gende Cursos",
    description: "Crie, gerencie e venda cursos e treinamentos com inscrições online, controle de turmas, certificados e automações",
    icon: GraduationCap,
    color: "from-indigo-500/20 to-indigo-600/10",
    functions: [
      {
        id: "gestao-cursos",
        title: "Gestão de Cursos e Turmas",
        summary: "Cadastre cursos, crie turmas, defina vagas e gerencie todo o ciclo de treinamentos.",
        description: "O módulo de Cursos permite criar cursos completos com ementa, carga horária, preço e modalidade (presencial, online ou híbrido). Cada curso pode ter várias turmas com datas, horários e instrutores diferentes. O sistema controla vagas automaticamente e gerencia listas de espera inteligentes.",
        whyImportant: "Profissionais da beleza que oferecem treinamentos precisam de uma ferramenta dedicada para gerenciar inscrições, turmas e pagamentos sem depender de planilhas ou anotações.",
        whenToUse: "Sempre que você oferecer cursos, workshops, masterclasses ou qualquer tipo de treinamento.",
        problemsSolved: [
          "Controle manual de inscrições em planilhas",
          "Overbooking de turmas",
          "Falta de página profissional para divulgar cursos",
          "Dificuldade em gerenciar múltiplas turmas simultaneamente",
          "Comunicação manual com alunos sobre datas e horários",
        ],
        benefits: [
          "Página pública profissional para cada curso com inscrição online",
          "Controle automático de vagas e lista de espera inteligente",
          "Dashboard dedicado com métricas de inscrições e receita",
          "14 automações de WhatsApp para toda a jornada do aluno",
          "Emissão de certificados em lote",
          "Financeiro separado para cursos",
        ],
        howToConfigure: [
          "Acesse Cursos > Cursos no menu lateral",
          "Clique em '+ Novo Curso' e preencha nome, descrição, preço, carga horária e modalidade",
          "Adicione imagem de capa, ementa e pré-requisitos (opcional)",
          "Publique o curso para gerar o link público de inscrição",
          "Crie turmas vinculadas ao curso com datas, horários e local/link",
        ],
        howToUse: [
          "Crie o curso com todas as informações",
          "Adicione uma ou mais turmas com datas específicas",
          "Compartilhe o link público para inscrições online",
          "Ou inscreva alunos manualmente pela aba Alunos",
          "Acompanhe inscrições e pagamentos no Dashboard de Cursos",
          "Emita certificados após a conclusão",
        ],
        tips: [
          "Use slugs curtos para facilitar o compartilhamento (ex: /cursos/corte-avancado)",
          "Configure as automações de WhatsApp ANTES de abrir inscrições",
          "Adicione materiais ao curso para disponibilizar na Área do Aluno",
        ],
        bestPractices: [
          "Mantenha descrições detalhadas e fotos profissionais nos cursos",
          "Defina um número de vagas realista para cada turma",
          "Publique cursos com pelo menos 2 semanas de antecedência",
          "Ative a lista de espera para capturar demanda extra",
        ],
        commonErrors: [
          "Não preencher a ementa e descrição, reduzindo a conversão",
          "Abrir inscrições sem configurar as automações",
          "Esquecer de atualizar o status de pagamento dos alunos",
        ],
        importantNotes: [
          "O sistema usa travas atômicas para evitar overbooking nas turmas",
          "Alunos na lista de espera são notificados automaticamente quando uma vaga abre",
          "O financeiro de cursos é independente do financeiro de agendamentos",
        ],
        expectedResult: "Gestão profissional e automatizada de cursos, com inscrições online, controle total de turmas e comunicação automática com alunos.",
      },
      {
        id: "inscricoes-alunos",
        title: "Inscrições e Alunos",
        summary: "Gerencie inscrições, pagamentos e dados dos alunos de cada turma.",
        description: "Controle completo de cada inscrição: dados do aluno (nome, telefone, e-mail, CPF, cidade), status de matrícula, status de pagamento e método de pagamento. Alunos podem se inscrever pela página pública ou ser cadastrados manualmente.",
        whyImportant: "Um controle eficiente de inscrições evita confusões, garante que todos os pagamentos sejam registrados e permite uma comunicação personalizada com cada aluno.",
        whenToUse: "Para gerenciar todos os alunos inscritos em suas turmas.",
        problemsSolved: [
          "Perda de dados de alunos",
          "Pagamentos não rastreados",
          "Dificuldade em saber quem pagou e quem não pagou",
          "Comunicação manual com cada aluno individualmente",
        ],
        benefits: [
          "Ficha completa de cada aluno",
          "Controle de pagamento por inscrição",
          "Filtros por turma, status e pagamento",
          "Automações de WhatsApp por status de pagamento",
        ],
        howToConfigure: ["O módulo está disponível automaticamente ao criar cursos e turmas."],
        howToUse: [
          "Acesse Cursos > Alunos para ver todas as inscrições",
          "Use os filtros para buscar por turma, status ou nome",
          "Clique em uma inscrição para editar dados ou atualizar pagamento",
          "Para inscrição manual, clique em '+ Nova Inscrição'",
          "Preencha os dados do aluno e selecione a turma desejada",
        ],
        tips: [
          "Sempre registre o telefone com DDD para as automações funcionarem",
          "Atualize o status de pagamento rapidamente — isso dispara a automação de confirmação",
          "Use o campo de notas para informações específicas do aluno",
        ],
        bestPractices: [
          "Confirme pagamentos no mesmo dia do recebimento",
          "Revise a lista de alunos pendentes semanalmente",
          "Exporte os dados antes do início do curso como backup",
        ],
        commonErrors: [
          "Não atualizar o status de pagamento",
          "Cadastrar aluno sem telefone, impedindo automações",
          "Duplicar inscrições por falta de busca prévia",
        ],
        importantNotes: [
          "Inscrições públicas são registradas automaticamente na turma selecionada",
          "O CPF é opcional mas recomendado para emissão de certificados",
        ],
        expectedResult: "Controle total sobre quem está inscrito, quem pagou e comunicação automatizada com todos os alunos.",
      },
      {
        id: "certificados-cursos",
        title: "Certificados",
        summary: "Emita e envie certificados de conclusão para seus alunos.",
        description: "Após a conclusão de um curso, você pode emitir certificados individuais ou em lote. Os certificados podem ser enviados automaticamente por WhatsApp aos alunos.",
        whyImportant: "Certificados agregam valor ao treinamento, aumentam a satisfação do aluno e geram marketing orgânico quando compartilhados nas redes sociais.",
        whenToUse: "Após a conclusão de cada turma ou curso.",
        problemsSolved: [
          "Emissão manual e demorada de certificados",
          "Alunos cobrando certificados",
          "Falta de padronização dos certificados",
        ],
        benefits: [
          "Emissão rápida individual ou em lote",
          "Envio automático por WhatsApp",
          "Padrão profissional para todos os certificados",
          "Marketing orgânico quando alunos compartilham",
        ],
        howToConfigure: [
          "Ao criar o curso, marque a opção 'Emite Certificado'",
          "Configure a automação de envio de certificado em Automações > Cursos",
        ],
        howToUse: [
          "Acesse Cursos > Certificados",
          "Selecione a turma desejada",
          "Clique em 'Emitir' para certificados individuais ou 'Emitir em Lote' para toda a turma",
          "Os certificados são enviados automaticamente por WhatsApp se a automação estiver ativa",
        ],
        tips: [
          "Emita certificados no mesmo dia da conclusão do curso",
          "Incentive alunos a compartilharem nas redes sociais",
          "Mantenha o envio automático por WhatsApp ativado",
        ],
        bestPractices: [
          "Emita em lote para economizar tempo",
          "Verifique os dados dos alunos antes de emitir",
          "Mantenha um registro de todos os certificados emitidos",
        ],
        commonErrors: [
          "Esquecer de emitir certificados após o curso",
          "Dados incorretos do aluno no certificado",
        ],
        importantNotes: [
          "Apenas alunos com status de matrícula 'confirmada' podem receber certificados",
          "Certificados ficam disponíveis também na Área do Aluno",
        ],
        expectedResult: "Emissão profissional e automatizada de certificados, com entrega imediata aos alunos.",
      },
      {
        id: "automacoes-cursos",
        title: "Automações de WhatsApp para Cursos",
        summary: "14 mensagens automáticas para toda a jornada do aluno.",
        description: "O sistema envia automaticamente mensagens por WhatsApp em todas as etapas da jornada: confirmação de inscrição, confirmação de pagamento, lembretes (7 dias, 1 dia, no dia), envio de localização/link da aula, avisos de turma remarcada/cancelada, nova turma para lista de espera, certificado, follow-up pós-curso, pedido de feedback e oferta de próximo curso.",
        whyImportant: "Automações reduzem drasticamente o trabalho manual de comunicação e garantem que nenhum aluno fique sem informação importante.",
        whenToUse: "Configure uma vez e deixe o sistema trabalhar automaticamente durante todo o ciclo do curso.",
        problemsSolved: [
          "Envio manual de lembretes e informações para cada aluno",
          "Alunos que esquecem a data ou local do curso",
          "Falta de comunicação sobre mudanças na turma",
          "Ausência de follow-up e coleta de feedback",
        ],
        benefits: [
          "Comunicação 100% automatizada",
          "Redução de faltas com lembretes progressivos",
          "Envio automático de localização e links de aula",
          "Coleta de feedback pós-curso",
          "Reengajamento com oferta de próximos cursos",
        ],
        howToConfigure: [
          "Acesse Automações no menu lateral",
          "Na seção 'Cursos', ative as automações desejadas",
          "Personalize cada mensagem clicando no ícone de edição",
          "Use variáveis como {curso}, {turma}, {data}, {link_aula}, {valor}, {link_certificado}",
          "Salve cada template personalizado",
        ],
        howToUse: [
          "Após configurar, as automações funcionam automaticamente",
          "Confirmações são enviadas ao inscrever e ao confirmar pagamento",
          "Lembretes são processados automaticamente pelo sistema (7 dias, 1 dia, no dia)",
          "Avisos de mudança são enviados ao alterar datas ou cancelar turmas",
          "Follow-up e feedback são enviados após o término do curso",
        ],
        tips: [
          "Personalize as mensagens com o nome do seu negócio",
          "Ative TODAS as automações para uma experiência completa do aluno",
          "Revise os templates periodicamente para mantê-los atualizados",
        ],
        bestPractices: [
          "Configure todas as automações ANTES de abrir inscrições",
          "Teste as mensagens enviando para seu próprio número",
          "Mantenha as mensagens curtas e informativas",
        ],
        commonErrors: [
          "Não ativar as automações antes de começar a inscrever alunos",
          "Mensagens muito longas que não são lidas",
          "Esquecer de atualizar o link da aula online",
        ],
        importantNotes: [
          "As automações dependem do WhatsApp estar conectado nas Configurações",
          "Cada automação pode ser ativada/desativada individualmente",
          "As mensagens de cursos são independentes das mensagens de agendamento",
        ],
        expectedResult: "Comunicação profissional e automatizada em todo o ciclo do curso, sem esforço manual, resultando em alunos mais informados e satisfeitos.",
      },
    ],
  },
];
