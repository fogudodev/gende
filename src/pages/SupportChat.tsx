...
const SupportChat = () => {
  ...
  // Mark support chat as seen when opening
  useEffect(() => {
    if (professional?.id) markAsSeen("support");
  }, [professional?.id]);
  ...
  return (
    <DashboardLayout title="Chat de Suporte" subtitle="Converse com nossa equipe de suporte">
                    ...
                    {msg.attachment_url && (
                      ...
                      >
                        <div className="flex items-center gap-2 bg-background/20 rounded-lg p-2 hover:bg-background/30 transition-colors">
                          <ImageIcon size={14} />
                          <span className="text-xs underline">Ver arquivo</span>
                        </div>
                      </a>
                    )}
